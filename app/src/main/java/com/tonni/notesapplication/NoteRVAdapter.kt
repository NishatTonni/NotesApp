...
class NoteRVAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val noteTv = itemView.findViewById<TextView>(R.id.TVNoteTitleID)
        val timeTv = itemView.findViewById<TextView>(R.id.TVTimeStampId)
        val deleteTV = itemView.findViewById<TextView>(R.id.IVDeleteId)
